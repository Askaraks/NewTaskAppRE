package com.example.newtaskappre.ui.profile
...
import com.example.newtaskappre.databinding.FragmentProfileBinding
    ...
    private fun initListeners() {
        ...
        binding?.btnSignOut?.setOnClickListener {
           ...
           lifecycleScope.launch {
            ...
            findNavController().navigate(com.example.newtaskappre.R.id.authFragment
            )
